    ...
    render() {
        return (
            <div className="layout-wrapper">
                <HeadMetadata
                    title="Personal Blog"
                    metaDescription="Walter Lutsyk is a beginner web developer that also writes about philosophy, fitness and nutrition"
                />
                <Header />
                <div className="homepage-container">
                    <div className="homepage-introduction">
                    <h1>Hi, I'm Walter Lutsyk. I am currently learning beginner level web development.</h1>
                    <p>I'm a beginner web developer that writes about modern Node.js, React, JavaScript development and life in general.</p>
                </div>
